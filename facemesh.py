...
class FaceMesh:
    ...
    def align(self, folderPath):
        ...
        for img_file in files:
            ...
            if not re.search("(jpg|jpeg|png|gif)$", img_file):
                continue
            ...
            if len(rects) > 0:
                ...
                cv2.imwrite("output/no_face_" + img_file + ".png", img.astype('uint8'))
                continue
            ...
            cv2.imwrite("output/face_" + img_file + ".png", warped_img.astype('uint8'))
            count += 1
        return imgs
        cv2.waitKey(0)
